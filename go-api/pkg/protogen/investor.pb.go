...
func (x *Portfolio) Reset() {
	*x = Portfolio{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_investor_proto_msgTypes[0]
...
func (*Portfolio) Descriptor() ([]byte, []int) {
	return file_proto_investor_proto_rawDescGZIP(), []int{0}
}
...
func (x *PortfolioListRequest) Reset() {
	*x = PortfolioListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_investor_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PortfolioListRequest) Descriptor() ([]byte, []int) {
	return file_proto_investor_proto_rawDescGZIP(), []int{1}
}
...
func (x *PortfolioRequest) Reset() {
	*x = PortfolioRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_investor_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PortfolioRequest) Descriptor() ([]byte, []int) {
	return file_proto_investor_proto_rawDescGZIP(), []int{2}
}

func (x *PortfolioRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PortfolioListResponse) Reset() {
	*x = PortfolioListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_investor_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PortfolioListResponse) Descriptor() ([]byte, []int) {
	return file_proto_investor_proto_rawDescGZIP(), []int{3}
}
...
func (x *PortfolioSummaryResponse) Reset() {
	*x = PortfolioSummaryResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_investor_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PortfolioSummaryResponse) Descriptor() ([]byte, []int) {
	return file_proto_investor_proto_rawDescGZIP(), []int{4}
}
...
var File_proto_investor_proto protoreflect.FileDescriptor

var file_proto_investor_proto_rawDesc = []byte{
	0x0a, 0x14, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x73, 0x74, 0x6f, 0x72,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x63,
	...
	,
}

var (
	file_proto_investor_proto_rawDescOnce sync.Once
	file_proto_investor_proto_rawDescData = file_proto_investor_proto_rawDesc
)

func file_proto_investor_proto_rawDescGZIP() []byte {
	file_proto_investor_proto_rawDescOnce.Do(func() {
		file_proto_investor_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_investor_proto_rawDescData)
	})
	return file_proto_investor_proto_rawDescData
}

var file_proto_investor_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_investor_proto_goTypes = []interface{}{
...
var file_proto_investor_proto_depIdxs = []int32{
	0, // 0: PortfolioListResponse.portfolios:type_name -> Portfolio
	1, // 1: Investor.GetPortfolioList:input_type -> PortfolioListRequest
	2, // 2: Investor.GetPortfolioSummaryMessage:input_type -> PortfolioRequest
	3, // 3: Investor.GetPortfolioList:output_type -> PortfolioListResponse
	4, // 4: Investor.GetPortfolioSummaryMessage:output_type -> PortfolioSummaryResponse
...
func init() { file_proto_investor_proto_init() }
func file_proto_investor_proto_init() {
	if File_proto_investor_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_investor_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_investor_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_investor_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_investor_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_investor_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_investor_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_investor_proto_goTypes,
		DependencyIndexes: file_proto_investor_proto_depIdxs,
		MessageInfos:      file_proto_investor_proto_msgTypes,
	}.Build()
	File_proto_investor_proto = out.File
	file_proto_investor_proto_rawDesc = nil
	file_proto_investor_proto_goTypes = nil
	file_proto_investor_proto_depIdxs = nil
}
