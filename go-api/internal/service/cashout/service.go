...
func (s *Service) CreateCashout(ctx context.Context, cashout *entity.Cashout) error {
	...
	portfolio, err := s.portfolioRepo.GetById(ctx, cashout.PortfolioId)
	if err != nil {
		return err
	}
...
func (s *Service) DeleteCashout(ctx context.Context, cashoutId int) error {
	userId := utils.GetCurrentUserId(ctx)
	cashout, err := s.cashoutRepo.GetById(ctx, cashoutId)
	if err != nil {
		return err
	}
	...
	err = s.cashoutRepo.Delete(ctx, cashoutId)
	if err != nil {
		return err
	}
	return nil
...
type Repository interface {
	...
	GetById(ctx context.Context, id int) (*entity.Cashout, error)
