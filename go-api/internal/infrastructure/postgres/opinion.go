...
func (pg *OpinionPostgres) Insert(ctx context.Context, o domain.Opinion) (domain.Opinion, error) {
...
func (pg *OpinionPostgres) Update(ctx context.Context, o domain.Opinion) error {
...
func (pg *OpinionPostgres) GetOpinionsList(ctx context.Context, f domain.OpinionFilters,
