...
func (pg *Transaction) GetByID(ctx context.Context, id int, userID int) (domain.Transaction, error) {
...
func (pg *Transaction) Insert(ctx context.Context, t domain.Transaction) (domain.Transaction, error) {
