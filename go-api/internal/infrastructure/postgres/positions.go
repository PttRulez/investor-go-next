...
func (pg *PositionPostgres) AddInfo(ctx context.Context, i domain.PositionUpdateInfo) error {
...
func (pg *PositionPostgres) GetPositionForSecurity(ctx context.Context,
	...
	if errors.Is(err, sql.ErrNoRows) {
		return domain.Position{}, database.ErrNotFound
	}
	if err != nil {
...
func (pg *PositionPostgres) Insert(ctx context.Context, p domain.Position) error {
...
func (pg *PositionPostgres) Update(ctx context.Context, p domain.Position) error {
	const op = "PositionPostgres.Update"
