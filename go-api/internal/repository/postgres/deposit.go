...
func (pg *DepositPostgres) GetById(ctx context.Context, id int) (*types.Deposit, error) {
...
func (pg *DepositPostgres) GetListByPortfolioId(ctx context.Context, id int) ([]*types.Deposit, error) {
...
func (pg *DepositPostgres) Insert(ctx context.Context, c *types.Deposit) error {
