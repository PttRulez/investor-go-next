...
func (pg *OpinionPostgres) Insert(ctx context.Context, o *types.Opinion) error {
...
func (pg *OpinionPostgres) Update(ctx context.Context, o *types.Opinion) error {
...
func (pg *OpinionPostgres) GetListByUserId(ctx context.Context, userId int) ([]*types.Opinion, error) {
