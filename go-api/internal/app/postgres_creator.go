...
import (
	...
	"github.com/pttrulez/investor-go/internal/repository/postgres/pgcashout"
	"github.com/pttrulez/investor-go/internal/repository/postgres/pgdeposit"
	"github.com/pttrulez/investor-go/internal/repository/postgres/pgexpert"
	pgmoexbond "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-bond"
	pgmoexbonddeal "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-bond-deal"
	pgmoexbondposition "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-bond-position"
	pgmoexshare "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-share"
	pgmoexsharedeal "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-share-deal"
	pgmoexshareposition "github.com/pttrulez/investor-go/internal/repository/postgres/pgmoex-share-position"
	"github.com/pttrulez/investor-go/internal/repository/postgres/pgportfolio"
	"github.com/pttrulez/investor-go/internal/repository/postgres/pguser"
)

func NewPostgresRepo(cfg config.PostgresConfig) (*repository.Repository, error) {
	...
	return &repository.Repository{
		Cashout: pgcashout.NewCashoutPostgres(db),
		Deal: repository.DealRepository{
			MoexBond:  pgmoexbonddeal.NewMoexBondDealPostgres(db),
			MoexShare: pgmoexsharedeal.NewMoexShareDealPostgres(db),
		},
		Deposit: pgdeposit.NewDepositPostgres(db),
		Expert:  pgexpert.NewExpertPostgres(db),
		Moex: repository.MoexRepository{
			Bond:  pgmoexbond.NewMoexBondsPostgres(db),
			Share: pgmoexshare.NewMoexSharesPostgres(db),
		},
		Portfolio: pgportfolio.NewPortfolioPostgres(db),
		Position: repository.PositionRepository{
			MoexBond:  pgmoexbondposition.NewMoexBondPositionPostgres(db),
			MoexShare: pgmoexshareposition.NewMoexSharePositionPostgres(db),
		},
		User: pguser.NewUserPostgres(db),
	}, nil
}
